        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/60">Getting projects details ready, hang tight!</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-4 w-full">
            ...
            <div className="text-xs text-white/60">Preparing all details…!!!!</div>
          </div>
          ...
          <div className="sr-only" aria-live="polite">Loading project details...!</div>
        </div>
      </div>
    </div>
  );
